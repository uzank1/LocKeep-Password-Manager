  ...
  const TRANSLATIONS = {
    ...
    en: {
      ...
      settings: {
        ...
        startupUpdateFailed: "The Windows startup setting could not be updated.",
        startupUnsupported: "Start with Windows is only available on Windows.",
        closeBehavior: "Window Closing",
        closeAction: "When closing the window",
        closeOptions: {"quit":"Quit the application","tray":"Minimize to system tray"},
        closeActionUpdateFailed: "The window closing setting could not be saved.",
        trayOpen: "Open LocKeep",
        trayQuit: "Quit LocKeep",
    ...
    de: {
      ...
      settings: {
        ...
        startupUpdateFailed: "Die Windows-Autostart-Einstellung konnte nicht aktualisiert werden.",
        startupUnsupported: "Autostart ist nur unter Windows verf\u00fcgbar.",
        closeBehavior: "Fenster schlie\u00dfen",
        closeAction: "Beim Schlie\u00dfen des Fensters",
        closeOptions: {"quit":"Anwendung beenden","tray":"In den Infobereich minimieren"},
        closeActionUpdateFailed: "Die Einstellung zum Schlie\u00dfen des Fensters konnte nicht gespeichert werden.",
        trayOpen: "LocKeep \u00f6ffnen",
        trayQuit: "LocKeep beenden",
    ...
    tr: {
      ...
      settings: {
        ...
        startupUpdateFailed: "Windows ba\u015flang\u0131\u00e7 ayar\u0131 g\u00fcncellenemedi.",
        startupUnsupported: "Windows ile birlikte ba\u015flatma yaln\u0131zca Windows'ta kullan\u0131labilir.",
        closeBehavior: "Pencereyi Kapatma",
        closeAction: "\u00c7arp\u0131 d\u00fc\u011fmesine bas\u0131ld\u0131\u011f\u0131nda",
        closeOptions: {"quit":"Uygulamay\u0131 kapat","tray":"Sistem tepsisine k\u00fc\u00e7\u00fclt"},
        closeActionUpdateFailed: "Pencere kapatma ayar\u0131 kaydedilemedi.",
        trayOpen: "LocKeep'i a\u00e7",
        trayQuit: "LocKeep'ten \u00e7\u0131k",
